...
(define (get-transformations n)
  (if (= n 1)
      null
      (append (get-transformations (quotient (+ n 1) 3)) (list (+ (modulo (+ n 1) 3) 1))); formule (analog cu heap ternar) :)  
      )
  )
...
(define (get-nth-tuple n tuple f1 f2 f3)
  (apply-functional-transformations (map (λ(x) ( cond
                                                  ((= x 1) f1)
                                                  ((= x 2) f2)
                                                  (else f3)
...
(define (get-nth-ppt-from-matrix-transformations n)
  (get-nth-tuple n '(3 4 5) ((curry multiply) T1) ((curry multiply) T2) ((curry multiply) T3)))
...
(define (get-nth-quadruple n)
  (get-nth-tuple n '(1 1 2 3) ((curry apply) Q1) ((curry apply) Q2) ((curry apply) Q3))
  )
...
(define (get-nth-ppt-from-GH-quadruples n)
  (let* ([tuple (get-nth-quadruple n)] [g (car tuple)] [e (cadr tuple)] [f (caddr tuple)] [h (cadddr tuple)])
    (list (* g h) (* 2 e f) (+ (* f f) (* e e)))
    )
  )
